...
public class DogService {
    private final DogRepositoryRef dogRepository;
    ...
    public List<GetDogListVo> selUserDogList(GetUserDogDto dto){
        ...
        return dogRepository.selUserDog(dto);
    }
    //-------------------------------------------------유저 강아지 등록---------------------------------------------------
    ...
    public ResVo insUserDog(InsUserDogDto dto){
        ...
        try {
            ...
            if(dto.getDogPic() != null){
                ...
                dogRepository.setUserDogPic(picDto);
            }
            return new ResVo(1);
        }catch (Exception e){
    ...
    public ResVo updUserDog(UpdUserDogDto dto){
        ...
        int result = dogRepository.updUserDog(dto);
